...
class _CalendarHomePageState extends State<CalendarHomePage> with CalendarDarkThemeMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: _buildSideDrawer(context, loginNotifier, studentNotifier, _currentPage),
  ...
  Widget _buildSideDrawer(BuildContext context, LogInNotifier loginNotifier, StudentNotifier studentNotifier, String currentPage) {
    return Drawer(
      child: Container(
        ...
        child: ListView(
          ...
          children: [
            DrawerHeader(
              ...
              child: Column(
                ...
                children: [
                  CircleAvatar(
                    radius: 36,
                    backgroundImage: loginNotifier.user?.photoURL != null
                        ? NetworkImage(loginNotifier.user!.photoURL!)
                        : null,
                    backgroundColor: Theme.of(context).colorScheme.onPrimary,
                    child: loginNotifier.user?.photoURL == null
                        ? Icon(
                            Icons.person,
                            size: 40,
                            color: Theme.of(context).colorScheme.primary,
            ...
            const Divider(),
            _buildDrawerItem('Log Out', Icons.logout, currentPage, onTap: () async {
  ...
  Widget _buildDrawerItem(String title, IconData icon, String currentPage, {VoidCallback? onTap}) {
    return ListTile(
      leading: Icon(
        icon,
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Row(
                        children: const [
                          Expanded(child: Text('S', textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14))),
                          Expanded(child: Text('M', textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14))),
                          Expanded(child: Text('T', textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14))),
                          Expanded(child: Text('W', textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14))),
                          Expanded(child: Text('T', textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14))),
                          Expanded(child: Text('F', textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14))),
                          Expanded(child: Text('S', textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14))),
                        ],
                      ),
                    ),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildProfileItem('Name', student.name),
                  _buildProfileItem('Major', student.major),
                  _buildProfileItem('Faculty', student.faculty),
                  _buildProfileItem('Current Semester', student.semester.toString()),
                  _buildProfileItem('Catalog', student.catalog),
                  if (student.preferences.isNotEmpty)
                    _buildProfileItem('Preferences', student.preferences),
                ],
              ),
            ),
          ),
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      _buildStatColumn(
                        'Semesters',
                        studentNotifier.coursesBySemester.length.toString(),
                      ...
                      _buildStatColumn(
                        'Credits',
                        studentNotifier.coursesBySemester.keys
  ...
  List<CalendarEventData> _getEventsFromCourses(StudentNotifier studentNotifier) {
                  ...
                  children: [
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final semesterKey = studentNotifier.coursesBySemester.keys
                            .firstWhere((key) => studentNotifier.coursesBySemester[key]!.contains(course));
                        ...
                        return ListTile(
                          ...
                          trailing: courseDetails != null && courseDetails.points.isNotEmpty
                              ? Container(
